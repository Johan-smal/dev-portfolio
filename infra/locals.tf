locals {
  ...
  public_dist_endpoint = var.is_localstack ? "https://localhost.localstack.cloud:4566/${aws_s3_bucket.public.bucket}" : "https://${aws_s3_bucket.public.bucket_domain_name}"
}